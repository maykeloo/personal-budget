...
<template>
  ...
  <div
    class="container flex relative min-h-screen flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0"
  >
    <RouterLink
      :to="redirectLink[view]"
      :class="
